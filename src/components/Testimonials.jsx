...
export default function Testimonials({ 
  ...
  // Check if items are screenshot type (have ratingLink and ratingImage)
  const isScreenshotType = items.length > 0 && 'ratingLink' in items[0]
    ...
    <section className="relative overflow-hidden bg-gray-900 py-24 sm:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        ...
        {isScreenshotType ? (
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:grid-cols-2 lg:mx-0 lg:max-w-none">
            {items.map((testimonial, index) => (
              ...
              >
                <Link
                  href={testimonial.ratingLink}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block group relative rounded-xl overflow-hidden bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all duration-300"
                >
                  {/* Hover Overlay */}
